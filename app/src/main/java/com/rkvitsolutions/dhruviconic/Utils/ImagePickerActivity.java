...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions(Context context, PickerOptionListener listener) {
        ...
        // add a list
//        String[] imageOption = {context.getString(R.string.lbl_take_camera_picture), context.getString(R.string.lbl_choose_from_gallery)};
        String[] imageOption = {context.getString(R.string.lbl_take_camera_picture)};
        builder.setItems(imageOption, (dialog, which) -> {
            switch (which) {
                case 0:
