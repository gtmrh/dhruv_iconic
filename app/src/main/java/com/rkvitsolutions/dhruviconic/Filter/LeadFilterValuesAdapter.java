...
public class LeadFilterValuesAdapter extends RecyclerView.Adapter<LeadFilterValuesAdapter.MyViewHolder> {

    private Context context;
    private Integer filterIndex;

    public LeadFilterValuesAdapter(Context context, Integer filterIndex) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int position) {
        final LeadFilter tmpHotelFilter = LeadFilterPreferences.filters.get(filterIndex);
        myViewHolder.value.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LeadFilterPreferences.filters.put(filterIndex, tmpHotelFilter);
    ...
    public int getItemCount() {
        return LeadFilterPreferences.filters.get(filterIndex).getValues().size();
    }
