...
public class ApplyResignation extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apply_resignation);
    ...
    private void initView() {
        ...
        empListAutoText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(ApplyResignation.this, android.R.layout.simple_dropdown_item_1line, empNameList);
        ...
        fromDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(ApplyResignation.this, date, myCalendar
                        .get(Calendar.YEAR),
...
//                FancyToast.makeText(Projects.this, "Try Again!", FancyToast.LENGTH_LONG, FancyToast.ERROR, false).show();
    ...
    private void applyForResign() {
        ...
        Call<LeaveModel> call = apiInterface.applyResign(UserCode, currentDate,FromDate, ToDate, Reason);
        call.enqueue(new Callback<LeaveModel>() {
            ...
            public void onResponse(Call<LeaveModel> call, retrofit2.Response<LeaveModel> response) {
                ...
                if (response.isSuccessful()) {
                    if (response.body().getStatus().equalsIgnoreCase("Record Saved Successfully")) {
                        ...
                        FancyToast.makeText(ApplyResignation.this, "Resign Applied", FancyToast.LENGTH_LONG, FancyToast.SUCCESS, false).show();
                        finish();

                    } else {
                        Log.v("Error", response.errorBody().toString());
                        FancyToast.makeText(ApplyResignation.this, "Sorry! Please try again later.", FancyToast.LENGTH_LONG, FancyToast.ERROR, false).show();
                    }
            ...
            public void onFailure(Call<LeaveModel> call, Throwable t) {
                progress.cancel();
                FancyToast.makeText(ApplyResignation.this, "Sorry! Something went wrong!.", FancyToast.LENGTH_LONG, FancyToast.ERROR, false).show();
                call.cancel();
            }
        });
...
//                    loader.setVisibility(View.GONE);
//                    layoutview.setVisibility(View.VISIBLE);
                    FancyToast.makeText(ApplyResignation.this, "Try Again!", FancyToast.LENGTH_LONG, FancyToast.ERROR, false).show();
                }
            }
