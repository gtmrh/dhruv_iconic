...
public class InterviewsAdaptor extends RecyclerView.Adapter<InterviewsAdaptor.MyViewHlder> {
    ...
    public InterviewsAdaptor(Activity activity, List<CandidateModel> list, CandidatesFragment fragment) {
